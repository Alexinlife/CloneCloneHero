...
Communication::Communication()
{
    ...
    input_names = new std::string[10]{ "Switch1", "Switch2", "Switch3", "Switch4", "Switch5", "JoyStickX", "JoyStickY", "AccelX", "AccelY", "AccelZ" };
}
...
-----------------------------------------------------------------------------*/
bool Communication::receiveFrom(SerialPort* arduino, std::string& msg)
{
    // Return 0 if error
